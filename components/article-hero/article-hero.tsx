        ...
        <div className="flex items-center justify-between mb-8 pb-8 border-b border-border">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              {showDropdown && (
                <div className="absolute right-0 top-full mt-2 w-52 bg-popover border border-border rounded-xl shadow-lg z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                  {shareLinks.map((link) => (
                    <a
                      key={link.name}
                      href={link.href}
